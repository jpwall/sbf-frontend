            ...
            <React.Fragment>
              ...
              <div className="primaryContainer">
                <div className="internalContainer" id="internalOverride">
                  ...
                  <p>First, it will be used to cover the $0.05 phone verification fee per user. Next, it will be applied to server and hosting costs. As it currently stands, donations are not being used for profit. Your donation will be allocated to anything related to development and maintenance of STUDIUS.</p>
